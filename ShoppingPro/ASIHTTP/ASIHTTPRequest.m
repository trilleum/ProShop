...
+ (void)registerForNetworkReachabilityNotifications
{
	[[ATReachability reachabilityForInternetConnection] startNotifier];
...
{
	return ([[ATReachability reachabilityForInternetConnection] currentReachabilityStatus] == ReachableViaWWAN);	
}
